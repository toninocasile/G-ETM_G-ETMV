...
function llk = computeLogLikelihood_SpikeTrains_trialByTrialVar(...
	Spikes, beta_Trials, beta_Global, ...
...
for currTrialInd = 1:nTrials
	...
	% modulation computed for the current trial
	trialLambda = beta_Trials(currTrialInd);
	...
	% compute probability
	totalLambda = globalLambda + historyLambda + trialLambda;
